...
|7. **[`v2-full`](https://github.com/sirampy/Team22/tree/v2-full#)**|Version-2 with pipelining and cache incorporated. work on this branch was stopped before completion to focus on other pipelining branches. This branch still contains a bunch of lagacy files.|
